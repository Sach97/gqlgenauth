...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Instructions.Text":
		...
		return e.complexity.Instructions.Text(childComplexity), true
...
func (ec *executionContext) _Instructions_text(ctx context.Context, field graphql.CollectedField, obj *Instructions) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Instructions",
...
func (ec *executionContext) _Mutation_signup(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	res := resTmp.(*Instructions)
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNInstructions2ᚖgithubᚗcomᚋSach97ᚋninshooᚑhasuraᚐInstructions(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_login(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNAuthPayload2ᚖgithubᚗcomᚋSach97ᚋninshooᚑhasuraᚐAuthPayload(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Instructions(ctx context.Context, sel ast.SelectionSet, obj *Instructions) graphql.Marshaler {
	fields := graphql.CollectFields(ctx, sel, instructionsImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("Instructions")
		case "text":
			out.Values[i] = ec._Instructions_text(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		default:
...
func (ec *executionContext) marshalNAuthPayload2githubᚗcomᚋSach97ᚋninshooᚑhasuraᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v AuthPayload) graphql.Marshaler {
	return ec._AuthPayload(ctx, sel, &v)
}

func (ec *executionContext) marshalNAuthPayload2ᚖgithubᚗcomᚋSach97ᚋninshooᚑhasuraᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v *AuthPayload) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalNInstructions2githubᚗcomᚋSach97ᚋninshooᚑhasuraᚐInstructions(ctx context.Context, sel ast.SelectionSet, v Instructions) graphql.Marshaler {
	return ec._Instructions(ctx, sel, &v)
}

func (ec *executionContext) marshalNInstructions2ᚖgithubᚗcomᚋSach97ᚋninshooᚑhasuraᚐInstructions(ctx context.Context, sel ast.SelectionSet, v *Instructions) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
